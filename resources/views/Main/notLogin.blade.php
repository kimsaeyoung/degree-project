...
<body>
    ...
    <script type="text/javascript" src="js/jquery.scrollfollow.js"></script> {{--리모콘--}}

    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css"> {{--프로젝트롤업??--}} {{--
    ...
    <div id="testbanner">
        <center>
            ...
            <br> --}}{{--
            <button type="button" class="btn btn-info" onclick="location.href='/projectwrite'">프로젝트등록하기</button>--}}{{--
        </center>
    </div>--}}

    <div class="container2"> {{--메인스크롤페이지--}}
        ...
        <section style="background: #40CCB5">
            ...
            <div class="chart_content">
                <ul class="chart_content">
                    <li class="chart" data-percent="75"><span>{{$count_designer}}</span>
                        <br>
                        <br>Designer</li>
                    <li class="chart" data-percent="50"><span>{{$count_going_pj[0]->st_num}}</span>
                        <br>진행중
                        <br>
                        <br>프로젝트</li>
                    <li class="chart" data-percent="83"><span>{{$count_developer}}</span>
                        <br>
                        <br>Developer</li>
                </ul>
                {{--
            ...
            <div class="calorie-counter">
                ...
                <div class="mChart chart--calorie js-chart" data-goal="1700" data-count="550">
                    ...
                    <div class="chart__count">
                        <div>
                            <span class="js-count" data-count="{{$count_going_pj[0]->st_num}}">{{$count_going_pj[0]->st_num}}</span> / <span class="js-count" data-count="{{$total}}">{{$total}}</span>
                        </div>
                        진행중 / 총개수
                    </div>
                    <!--  /.chart__count -->
                ...
                <div class="mChart chart--protein js-chart" data-goal="{{$count_designer+$count_developer}}" data-count="{{$count_designer}}">
                    <div class="chart__container">
                    ...
                    <div class="chart__count .chart__count--protein">
                        <div>
                            <span class="js-count" data-count="{{$count_designer}}">0</span>g / <span class="js-count" data-count="{{$count_designer+$count_developer}}">0</span>g
                        </div>
                        Designer
                    </div>
                ...
                <div class="mChart chart--carbs js-chart" data-goal="{{$count_designer+$count_developer}}" data-count="{{$count_developer}}">
                    <div class="chart__container">
                    ...
                    <div class="chart__count .chart__count--carbs">
                        <div>
                            <span class="js-count" data-count="{{$count_developer}}">0</span>g / <span class="js-count" data-count="{{$count_developer+$count_designer}}">0</span>g
                        </div>
                        Developer
                    </div>
                    <!--  /.chart__count--carbs -->
        ...
        <section style="background: #FFC765">
            ...
            <div class="slider"> {{--포트폴리오 슬라이드 portfolio siled--}}
