...
<script>
    ...
    socket.on('note', function(data) {
        ...
        if ('{{ Session::get('m_num') }}' == data.receiver ) {
...
<style>
    ...
    body {
        ...
        background: url({{asset('img/mainback.jpg')}}) no-repeat center center fixed;
...
<div class="modal fade" id="msgModal" role="dialog">
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                   {{-- 보내는 사람 -> sender(int) id="sender"--}}
                    <input type="hidden" id ="msgSender" name="sender" class="form-control"  value="{{Session::get('m_num')}}">
                    {{--메시지를 Ajax를 사용하여 post형식으로  보내주기 위함 --}}
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <label for="name">받는 사람</label><br>
                    {{-- 받는 사람 -> receiver(int)  id ="receiver" --}}
...
<div class="mainheader">
    ...
    <div id="hCenter">
        <ul id="hContent">
            ...
            @else <?php $result=Session::get('m_num')?>
                <li><a href="/work/choice_timeline/{{$result}}">Work</a><div class="hLine"></div></li>
            @endif-->
        </ul>
    </div>
    ...
    <div id="hRight">
        <ul id="hIcon">
            ...
            @else
            <li><a href="/messageList/{{Session::get('m_num')}}"><span class="glyphicon glyphicon-envelope"></span>&nbsp;message</a></li>
...
<div class="mHeader">
    ...
    <button id="mLogin">
        @if(!Session::has('m_info'))
        <span id="mMenuLogin" class="glyphicon glyphicon-minus" aria-hidden="true"></span> @else
        <span id="mMenuLogout" class="glyphicon glyphicon-minus" aria-hidden="true"></span> @endif
    </button>
...
<div id="mMenuBox">
    ...
    <a href="/messageList/{{Session::get('m_num')}}" class="btn btn-default">Message</a>
</div>
