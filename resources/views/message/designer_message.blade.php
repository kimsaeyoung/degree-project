                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span id="msg_content" onclick="javascript:readCheck( {{ $results[$i]->msg_num}} , {{$results[$i]->receiver }} );">{{$results[$i]->msg_content}}</span>
                                        </input>
                                    </td>

                                    <!-- 보낸날짜 -->
                                    <td>{{$results[$i]->msg_date}}</td>
                                    <!--상세보기기-->
                                    <td>
