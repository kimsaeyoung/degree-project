...
<br><br>
    ...
    <form action="/companypage/update" method="post" enctype="multipart/form-data">
                        ...
                        <div style="margin-left: 20px">
                            <h4>
                                @if($result->m_num != Session::get('m_num'))
                                    {{$result->m_name}}
                                @else
                                    <input type="text" value="{{$result->cp_represent}}" class="form-control" name="cp_represent">
                                @endif
                            </h4>
                        </div>
                    </td>
                        ...
                        <div style="margin-left: 20px">
                            <h4>
                                @if($result->m_num != Session::get('m_num'))
                                    {{$result->m_phone}}
                                @else
                                    <input type="text" value="{{$result->cp_tel}}" class="form-control" name="cp_tel">
                                @endif</h4>
                        </div>
                    </td>
                </tr>
        ...
        <div class="form-group">
            <textarea class="form-control" rows="5" cols="65" name="cp_info" id="comment" @if($result->m_num != Session::get('m_num'))readonly @endif>{{$result->cp_info}}</textarea>
        </div>
        @if(Session::get('m_num') == $result->m_num   )
