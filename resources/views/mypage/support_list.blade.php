...
<div class="container">
    ...
    <a href="/designerpage/project/{{$result}}" id="sub_menu_btn" class="btn btn-default">지원한 프로젝트</a>
    <br>
    <br><br><br>
                ...
                <span class="db_data_form" style="font-size: 35px;">
                    ...
                    <div class="div_1_a">
                        <div class="div_pj_date" style="float: right; margin-top: -50px">
                            <ul><span class="glyphicon glyphicon-yen"></span>등록일자 : {{$result->created_at}} </ul>
                        </div>
                    </div>
                    ...
                    <div class="div_2" style="text-align: center">
                        ...
                        <div class="div_2_a">마감일<div class="circle">{{--{{$result->pj_date}}--}}5/14</div></div>
                        <div class="div_2_a">예상기간<div class="circle">{{$result->expect_date}}</div></div>
                        <div class="div_2_a">모집인원<div class="circle">{{$result->pj_people}}</div></div>
                        <div class="div_2_a">지 역<br><div class="circle">{{$result->pj_area}}</div></div>
                    ...
                    <div class="div_4" style="text-align: left;  margin-left: 15px" >
                        <span class="glyphicon glyphicon-yen"></span><span style="border-right: 1px solid; padding-right: 10px">예상금액 : {{$result->pj_price}}</span>
