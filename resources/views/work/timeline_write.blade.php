                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                                ...
                                {{$result[0]->pj_title}}
                                <input type="hidden" id ="pj_num" class="form-control" value="{{$result[0]->pj_num}}"/></input>
                                <br>
                                <label class="col-md-3 control-label" for="tI_content">작성자</label>
                                {{Session::get('m_name')}}
                                <?php $put=Session::get('m_num')?>
                                <input type="hidden" id ="m_num" class="form-control" value="{{$put}}"> </input>
                                <br>
                                {{--<label class="col-md-3 control-label" for="tI_content" >작성시간</label>
