...
<?php $__env->startSection('d_style'); ?>
<style>
    .middle{
        margin: 30px auto;
        width: 1000px;
...
<?php $__env->startSection('d_content'); ?>
    <div class="middle animsition" data-animsition-in-class="fade-in-down" data-animsition-in-duration="1000" data-animsition-out-class="fade-out-down" data-animsition-out-duration="800">
            ...
            <section>
                ...
                <div id="hs_menu1">
                <?php foreach($academy_list as $row): ?>
                    <div id="ac_<?php echo e($row->ac_num); ?>">
                        <div class="hs_menu_3"><?php echo e($row->ac_name); ?></div>
                        <div class="hs_menu_3"><?php echo e($row->ac_specialty); ?></div>
                        <div class="hs_menu_3"><?php echo e($row->ac_start_date); ?> ~ <?php echo e($row->ac_end_date); ?></div>
                        <?php if($designer_num == Session::get('m_num')): ?>
                        <a class="btn btn-primary"  onclick="academy_delete('<?php echo e($row->ac_num); ?>')">消す</a>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
                </div>
            ...
            <section>
                ...
                <div id="cr_menu">
                    <?php foreach($career_list as $row): ?>
                        <div id="cr_<?php echo e($row->cr_num); ?>">
                            <div class="hs_menu_4"><?php echo e($row->cr_name); ?></div>
                            <div class="hs_menu_4"><?php echo e($row->cr_content); ?></div>
                            <div class="hs_menu_4"><?php echo e($row->cr_position); ?></div>
                            <div class="hs_menu_4"><?php echo e($row->cr_start_date); ?>~<?php echo e($row->cr_end_date); ?></div>
                            <?php if($designer_num == Session::get('m_num')): ?>
                            <a class="btn btn-primary"  onclick="cr_delete('<?php echo e($row->cr_num); ?>')">消す</a>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                </div>
            ...
            <section>
                ...
                <div class="lic_menu">
                    <?php foreach($licenese_list as $row): ?>
                        <div id="lic_<?php echo e($row->lic_num); ?>">
                            <div class="hs_menu_3"><?php echo e($row->lic_name); ?></div>
                            <div class="hs_menu_3"><?php echo e($row->lic_pyot); ?></div>
                            <div class="hs_menu_3"><?php echo e($row->lic_date); ?></div>
                            <?php if($designer_num == Session::get('m_num')): ?>
                            <a class="btn btn-primary"  onclick="licenese_delete('<?php echo e($row->lic_num); ?>')">消す</a>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                </div>
            ...
            <section>
                ...
                <div class="sk_menu">
                    <?php foreach($skill_list as $row): ?>
                        <div id="sk_<?php echo e($row->sk_num); ?>">
                            <div class="hs_menu_3"><?php echo e($row->sk_name); ?></div>
                            <div class="hs_menu_3" ><?php echo e($row->sk_grade); ?></div>
                            <div class="hs_menu_3" ><?php echo e($row->sk_time); ?>年</div>
                            <?php if($designer_num == Session::get('m_num')): ?>
                            <a class="btn btn-primary"  onclick="sk_delete('<?php echo e($row->sk_num); ?>')">消す</a>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                </div>
        ...
        function skill_add(){
            ...
            $.ajax({
                ...
                data:{
                    ...
                    'sk_grade':sk_grade,
                    'sk_time':sk_time,
                    'm_num':'<?php echo e(Session::get('m_num')); ?>'
                },
                dataType:'json',
                success:function(data){
