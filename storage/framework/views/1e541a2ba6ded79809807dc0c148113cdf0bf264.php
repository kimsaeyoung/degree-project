...
<?php $__env->startSection('d_content'); ?>
    ...
    <div class="career_container animsition" data-animsition-in-class="fade-in-down" data-animsition-in-duration="1000" data-animsition-out-class="fade-out-down" data-animsition-out-duration="800">
        ...
        <?php foreach($end_project as $row): ?>
            <?php if($row->st_num == 5 ): ?>
          <div class="end_project">
                <table>
                    <tr>
                        <th colspan="5" class="th_title"><h3 class="end_pj_title"><?php echo e($row->pj_title); ?></h3></th>
                    </tr>
                    <tr>
                        <td class="td_100">
                            デザイン
                    ...
                    <tr>
                        ...
                        <td width="50">
                            <button onclick="grade('<?php echo e($row->pj_num); ?>','<?php echo e($m_num); ?>')" class="modalLink">評点</button>
                        </td>
                    </tr>
                </table>
    ...
    <script>
                  ...
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          for(var i=0; i<data[1].gd_professional; i++){
                                  $('.gd_professional').append('<img src="<?php echo e(asset('star.png')); ?>"  class="professional">');
                              }
                          for(var i=0; i<data[1].gd_plan; i++){
                                  $('.gd_plan').append('<img src="<?php echo e(asset('star.png')); ?>"  class="plan">');
                              }
                          for(var i=0; i<data[1].gd_satisfaction; i++){
                                  $('.gd_satisfaction').append('<img src="<?php echo e(asset('star.png')); ?>"  class="satisfaction">');
                              }
        ...
        //
        var dataset = [
            { name: 'Web', percent: '<?php echo e($web_count->web_count); ?>' },
            { name: 'App', percent: '<?php echo e($app_count->app_count); ?>'},
            { name : '合 : <?php echo e($web_count->web_count + $app_count->app_count); ?>'}
        ];
    ...
    <script>
        $(function () {
            $('#average').highcharts({
                ...
                series: [{
                    name: '',
                    data: [<?php echo e($grade->gd_professional); ?>, <?php echo e($grade->gd_plan); ?>,<?php echo e($grade->gd_satisfaction); ?>],
                    pointPlacement: 'on'
                }]
