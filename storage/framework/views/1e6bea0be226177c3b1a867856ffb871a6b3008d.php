...
<div class="container">
    ...
    <div id="dTitle">
        ...
        <h1>계약 목록</h1>
        <h5>현재 <span><?php /*$count*/ ?></span>개의 계약이 등록되어 있습니다.</h5>
    ...
    <div class="left_side_menu">
        ...
        <div class="sort_box">
            <?php /*<label><input class="num_info" id="project" type="checkbox" value="" name="number">프로젝트 높은순</label>
    ...
    <div id="middle">
        <?php foreach($result as $row): ?>
            <div class="contractBox">
                <a class="cbText" onclick="contractViewModal(<?php echo e($row->tmp_num); ?>)">
                    <h4>개발사</h4>
                    <h4><?php echo e($row->devel_name); ?></h4>
                    <h4>프로젝트</h4>
                    <h4><?php echo e($row->pj_title); ?></h4>
                    <h4>금액</h4>
                    <h4><?php echo e($row->tmp_money); ?>&nbsp;원</h4>
                    <h4>기간</h4>
                    <h4><?php echo e($row->tmp_start_date); ?><br>~&nbsp;<?php echo e($row->tmp_end_date); ?></h4>
                </a>
            </div>
        <?php endforeach; ?>
    </div>
