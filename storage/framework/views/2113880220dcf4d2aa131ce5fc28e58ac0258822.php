       ...
       <?php foreach($results as $result): ?>
        ...
        <div class="col-lg-4">
                ...
                <p style="text-align: center; margin-top: 20px;">
                    <i class="fa fa-user" style="font-size: 147px;"><img src="<?php echo e(asset('img/member_face/'.$result->m_face)); ?>" id="face_img" style="width: 230px; height: 140px;"></i>
                </p>
                <div class="header">
                    <?php /*<div class="blur"></div>*/ ?>
                        ...
                        <div class="panel panel-success" style="height: 247px;">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    프로젝트 명 : <?php echo e($result->pj_title); ?>

                                </div>
                                <div class="form-group">
                                    지원자 성명 : <?php echo e($result->m_name); ?>

                                </div>
                                <div class="form-group">
                                    지원자 연락처 : <?php echo e($result->m_phone); ?>

                                <br><br>
                                    <div class="form-group">
                                        지원자 지역 : <?php echo e($result->m_area); ?>
