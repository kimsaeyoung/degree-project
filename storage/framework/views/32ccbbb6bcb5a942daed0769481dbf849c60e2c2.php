...
<div class="nav">
    <div class="container">
        ...
        <a href="/designer/pf_modifyView/<?php echo e(Session::get('m_num')); ?>" id="sub_menu_btn" class="btn btn-default">포트폴리오 수정</a>
        <a href="/designerpage/project" id="sub_menu_btn" class="btn btn-default">지원한 프로젝트</a>
        <!-- 디자이너 개인정보  -->
    </div>

    <?php echo $__env->yieldContent('designer_section'); ?>
</div>