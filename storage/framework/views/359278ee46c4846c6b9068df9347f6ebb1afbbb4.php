...
<?php $__env->stopSection(); ?> <?php $__env->startSection('d_content'); ?>
...
<div class="designer_information animsition" data-animsition-in-class="fade-in-down" data-animsition-in-duration="1000" data-animsition-out-class="fade-out-down" data-animsition-out-duration="800">
    <form action="/designer/intro_modify" method="post" enctype="multipart/form-data" style="">
        ...
        <div class="wrapper">
            <?php if($results->m_face != null): ?>
            <img src="<?php echo e(asset('img/member_face/'.$results->m_face)); ?>" id="face_img"> <?php else: ?>
            <img src="<?php echo e(asset('img/member_face/no_face.jpg')); ?>" id="face_img"> <?php endif; ?>
            ...
            <table id="table">
                <tr>
                    ...
                    <td class="td_right">
                        <div style="margin-left: 20px">
                            <?php if($results->m_num != Session::get('m_num')): ?>
                            <?php echo e($results->m_name); ?>

                            <?php else: ?>
                                <input type="text" value="<?php echo e($results->m_name); ?>" class="form-control" name="m_name">
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="td_right">
                        <div style="margin-left: 20px">
                            <?php if($results->m_num != Session::get('m_num')): ?>
                                <?php echo e($results->m_phone); ?>

                            <?php else: ?>
                                <input type="text" value="<?php echo e($results->m_phone); ?>" class="form-control" name="m_phone">
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="td_right">
                        <div style="margin-left: 20px">
                            <?php if($results->m_num != Session::get('m_num')): ?>
                                <?php echo e($results->m_email); ?>

                            <?php else: ?>
                                <input type="text" value="<?php echo e($results->m_email); ?>" class="form-control"  name="m_email">
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="td_right">
                        <div style="margin-left: 20px">
                            <?php if($results->m_num != Session::get('m_num')): ?>
                                <?php echo e($results->m_area); ?>

                            <?php else: ?>
                                <input type="text" name="m_area" list="area_list" class="form-control" value="<?php echo e($results->m_area); ?>">
        ...
        <div class="form-group">
            <textarea class="form-control" rows="5" cols="65" name="ds_info" id="comment" <?php if($results->m_num != Session::get('m_num')): ?>readonly <?php endif; ?>><?php echo e($results->ds_info); ?></textarea>
        </div>
        <?php if(Session::get('m_num') == $results->m_num): ?>
