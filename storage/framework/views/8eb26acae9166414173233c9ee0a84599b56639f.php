                ...
                ?>
                    <ul id='timeline'>
                        <li class='work'>
                            ...
                            <div class="relative">
                                <label  for='work<?=$i?>'><?php echo e($m_name[$i]->m_name); ?></label>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <button class="btn btn-primary" id="ds_success" data-dismiss="modal" onclick="ds_success(<?php echo e($project->pj_num); ?>,<?php echo e(Session::get('m_num')); ?>)">예</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"
                onclick="project_clear(<?php echo e($project->pj_num); ?>,<?php echo e($ds_num[0]->m_num); ?>)">확인</button>
