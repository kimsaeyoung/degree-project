...
<style>         /*메인div*/
    ...
    body .card .profile {
        ...
        height: 80px;
        width: 80px;
        background-image: url(../img/member_face/<?php echo e($name=Session::get('m_face')); ?>);         /*프로필사진*/
        background-size: cover;
        background-position: center;
        border-radius: 100%;
        margin: 0 auto;
...
<body>
<div class="chart">                       <?php /*웹앱 차트 시작*/ ?>
    <center><b><h3>APP / WEB <br>プロジェクトの割合</h3></b></center>
    <div class="wrapper">
        <div class="graph">
            <div class="head-box max"><i class="fa fa-bar-chart"></i></div>
            <div id="bar-one" class="bar">APP (<?php echo e($app); ?>)</div>
            <div id="bar-two" class="bar">WEB (<?php echo e($web); ?>)</div>
        </div>
    </div>
    <?php /*<?php echo e($app_count[0]->count); ?>/<?php echo e($app_web_count[0]->count); ?>*100;*/ ?>
...
<div class="container">
    ...
    <!--<div class="profile_card">      <?php /*프로필 시작*/ ?>
        <h2>マイプロフィール</h2>
        <div class="card">
            <div class="cover">
                <div class="image"></div>
            ...
            <div class="info">
                <div class="title">
                    <?php echo e($name=Session::get('m_name')); ?>
                ...
                <div class="description">
                    <button class="btn btn-danger" onclick="location.href='/designer/<?php echo e(Session::get('m_num')); ?>'">MyPortlog</button>
                </div>
    ...
    </div>    -->                                      <?php /*프로필 끝 profile end*/ ?>



    <div class="project_table">                     <?php /*최근 등록 프로젝트 테이블 시작*/ ?>
        ...
        <table id="country-list" class="sortable-table">
            ...
            <tbody>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[0]->pj_num)?$new_project[0]->pj_num:'#'); ?>"><?php echo e(isset($new_project[0]->bc_name)?$new_project[0]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[0]->pj_title)?$new_project[0]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[0]->created_at)?$new_project[0]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[1]->pj_num)?$new_project[1]->pj_num:'#'); ?>"><?php echo e(isset($new_project[1]->bc_name)?$new_project[1]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[1]->pj_title)?$new_project[1]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[1]->created_at)?$new_project[1]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[2]->pj_num)?$new_project[2]->pj_num:'#'); ?>"><?php echo e(isset($new_project[2]->bc_name)?$new_project[2]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[2]->pj_title)?$new_project[2]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[2]->created_at)?$new_project[2]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[3]->pj_num)?$new_project[3]->pj_num:'#'); ?>"><?php echo e(isset($new_project[3]->bc_name)?$new_project[3]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[3]->pj_title)?$new_project[3]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[3]->created_at)?$new_project[3]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[4]->pj_num)?$new_project[4]->pj_num:'#'); ?>"><?php echo e(isset($new_project[4]->bc_name)?$new_project[4]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[4]->pj_title)?$new_project[4]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[4]->created_at)?$new_project[4]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[5]->pj_num)?$new_project[5]->pj_num:'#'); ?>"><?php echo e(isset($new_project[5]->bc_name)?$new_project[5]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[5]->pj_title)?$new_project[5]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[5]->created_at)?$new_project[5]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[6]->pj_num)?$new_project[6]->pj_num:'#'); ?>"><?php echo e(isset($new_project[6]->bc_name)?$new_project[6]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[6]->pj_title)?$new_project[6]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[6]->created_at)?$new_project[6]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[7]->pj_num)?$new_project[7]->pj_num:'#'); ?>"><?php echo e(isset($new_project[7]->bc_name)?$new_project[7]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[7]->pj_title)?$new_project[7]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[7]->created_at)?$new_project[7]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[8]->pj_num)?$new_project[8]->pj_num:'#'); ?>"><?php echo e(isset($new_project[8]->bc_name)?$new_project[8]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[8]->pj_title)?$new_project[8]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[8]->created_at)?$new_project[8]->created_at:'no data'); ?></td></tr>
            <tr><td><a href="/projectView/<?php echo e(isset($new_project[9]->pj_num)?$new_project[9]->pj_num:'#'); ?>"><?php echo e(isset($new_project[9]->bc_name)?$new_project[9]->bc_name:'no data'); ?></a></td><td><?php echo e(isset($new_project[9]->pj_title)?$new_project[9]->pj_title:'no data'); ?></td><td><?php echo e(isset($new_project[9]->created_at)?$new_project[9]->created_at:'no data'); ?></td>
            </tbody>
        </table>
