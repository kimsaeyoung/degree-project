...
<div class="container">
    ...
    <div id="dTitle">
        ...
        <h1>任数</h1>
        <h5>現在 <span><?php echo e($count); ?></span>名のデザイナーが登録されています。</h5>
    ...
    <div id="middle">
        <?php foreach($m_list as $row): ?>
        <div class="des_box_a">
            <div class="des_box_b">
                   
                <div class="des_inner_title"><?php echo e($row->m_name); ?></div>

                <div class="des_inner_1">
                    <figure class="effect-bubba">
                        <?php if($row->m_face != null): ?>
                        <img src="<?php echo e(asset('img/member_face/'.$row->m_face)); ?>"> <?php else: ?>
                        <img src="<?php echo e(asset('img/member_face/no_face.jpg')); ?>"> <?php endif; ?>
                        <figcaption>
                            <p><?php echo e($row->ds_info); ?></p>
                            <a href="/designer/<?php echo e($row->m_num); ?>" style="border-radius: 20px"></a>
                        </figcaption>
                    </figure>
                </div>

                <p class="des_inner_2">
                    <a href="/designer/portfolio2/<?php echo e($row->m_num); ?>">
                        <img src="<?php echo e(asset('img/project.png')); ?>"><br>
                        <span>PORTFOLIO : <?php if($row->pj_count==null): ?> 0 <?php else: ?> <?php echo e($row->pj_count); ?> <?php endif; ?></span>
                    </a>
                </p>

                <p class="des_inner_3">
                    <a href="/designer/career/<?php echo e($row->m_num); ?>">
                        <img src="<?php echo e(asset('img/money.png')); ?>"><br>
                        <span>取引件数 : <?php if($row->pt_count == null): ?> 0 <?php else: ?> <?php echo e($row->pt_count); ?> <?php endif; ?></span>
                    </a>
                </p>
            </div>
        </div>
    ...
    <div id="page_num">
        <?php if($m_name): ?>
        <div id="num">
            <?php echo e($m_list->appends(['m_name' => $m_name])->render()); ?>

        </div>
        <?php else: ?>
        <div id="num">
            <?php echo e($m_list->links()); ?>
