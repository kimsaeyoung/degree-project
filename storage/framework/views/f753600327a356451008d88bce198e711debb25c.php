...
<body>
    ...
    <div id="reg_con">
        ...
        <form method="post" action="<?php echo e(route('projectregister')); ?>" enctype="multipart/form-data" accept-charset="utf-8">
            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">

            <?php /*게시물 등록 시간*/ ?>
            <input type="hidden" name="created_at" value="<?php echo \Carbon\Carbon::now(); ?>">

            <?php /*계약상태 5단계 임을 나타냄*/ ?>
            <input type="hidden" name="st_num" value="1">

            <?php /*프로젝트 등록시 m_num를 구분*/ ?>
            <input type="hidden" name="m_num" value="<?php echo Session::get('m_num'); ?>">
...
10.装備持参するかどうか
                ...
                <tr>
                    <th>会社の位置</th>
                    <td id="reg_map_td">
                        <?php echo e(Form::open(array('url'=>'projectList','files'=>true))); ?>
